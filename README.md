...
Then clone the repo (or download [zip file](https://github.com/itxing666/koa-demos/archive/master.zip)).

```bash
$ git clone git@github.com:itxing666/koa-demos.git
```
...
Now play with the [source files](https://github.com/itxing666/koa-demos/tree/master/demos) under the demos directory.
